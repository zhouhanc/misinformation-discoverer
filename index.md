...
Misinformation is a persistent theat on today's Internet. The content of future misinformation (or fake news) is inherently unpredictable. So how do we discover potential fake news source preemptively? The idea is to focus on non-content signals, such as HTML page layouts or social network patterns. Misinformation Discoverer is an automated discovery system based on this _content-agnostic_ approach. 
